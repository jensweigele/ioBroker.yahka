...
"use strict";
module.exports = JSON.parse('{"name":"iobroker.yahka","version":"0.15.0","description":"ioBroker HomeKit Adapter","author":{"name":"Jens Weigele","email":"iobroker.yahka@gmail.com"},"contributors":[{"name":"Jens Weigele","email":"iobroker.yahka@gmail.com"}],"homepage":"https://github.com/jensweigele/ioBroker.yahka","license":"MIT","keywords":["ioBroker","iobroker.yahka","Smart Home","home automation","siri","homekit"],"repository":{"type":"git","url":"https://github.com/jensweigele/ioBroker.yahka"},"engines":{"node":">=12.0.0"},"dependencies":{"@iobroker/adapter-core":"^2.6.7","debug":"^4.3.4","dev-null":"^0.1.1","hap-nodejs":"^0.10.4","ip":"^1.1.8","macaddress":"0.5.3","util":"^0.12.4"},"devDependencies":{"@types/iobroker":"^4.0.5","@types/jquery":"^3.5.14","@types/node":"^16.11.65","assert":"^2.0.0","chai":"^4.3.6","crypto-browserify":"^3.12.0","grunt":"^1.5.3","grunt-contrib-clean":"^2.0.1","grunt-contrib-compress":"^2.0.0","grunt-contrib-copy":"^1.0.0","grunt-contrib-jshint":"^3.2.0","grunt-exec":"^3.0.0","grunt-http":"^2.3.3","grunt-jscs":"^3.0.1","grunt-replace":"^2.0.2","grunt-ts":"^6.0.0-beta.22","grunt-webpack":"^5.0.0","html-webpack-plugin":"^5.5.0","mocha":"^10.0.0","path-browserify":"^1.0.1","process":"^0.11.10","raw-loader":"^4.0.2","stream-browserify":"^3.0.0","timers":"^0.1.1","ts-loader":"^9.4.1","typescript":"^4.8.4","webpack":"^5.74.0","webpack-cli":"^4.10.0","webpack-node-externals":"^3.0.0","xml2js":"^0.4.23"},"bugs":{"url":"https://github.com/jensweigele/ioBroker.yahka/issues"},"readmeFilename":"README.md","main":"main.js","files":["admin/","main.js","LICENSE","README.md","io-package.json","hap-nodejs-community-types/"],"scripts":{"test":"node node_modules/mocha/bin/mocha --exit"}}');
